      ...
      <div class="container-fluid">
          ...
          <!-- left column -->
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="<?php echo base_url('yonetimpaneli/sosyalmedyaguncelle') ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Sosyal Medya Adı</label>
                    <input type="text" class="form-control" required value="<?php echo $bilgi->title; ?>" name="title" id="exampleInputEmail1" placeholder="Siteniz için isim giriniz.">
                    <input type="hidden" name="id" required value="<?php echo $bilgi->id; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Kullanıcı Adı</label>
                    <input type="text" name="url" required value="<?php echo $bilgi->url; ?>" class="form-control" id="exampleInputPassword1" placeholder="Kullanıcı adınızı yazınız.">
                  </div>
