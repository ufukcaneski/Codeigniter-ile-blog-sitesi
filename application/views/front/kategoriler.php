...
<nav class="shadow-sm rounded container navbar navbar-expand-lg navbar-dark theme-bg-primary-darken position-relative p-0 pl-3">
					...
					<div class="collapse navbar-collapse text-uppercase" id="menu">
                        ...
                        <?php foreach($kategoriler as $kategoriler) { ?>
							<li id="<?php echo $kategoriler->sef; ?>" class="nav-item mr-lg-3">
                            
							    <a class="kategori" style="<?php echo activek($kategoriler->sef); ?>" href="<?php echo base_url('kategori/'.$kategoriler->sef); ?>"><?php echo $kategoriler->title; ?></a>
...
<section class="section pt-5">
            <div class="container blog-cards">	        
                ...
                <?php if($bilgi) { foreach($bilgi as $bilgi) { $id = $bilgi->id; $katid = $bilgi->katid;  ?>
                    ...
                    <?php } } else { ?>
                        <div class="col-12 d-flex justify-content-center mb-5"><span class="text-white theme-bg-primary-darken rounded p-1">Bu kategoride henüz yazı eklenmemiştir.</span></div>
                  <?php  } ?>
